<template>
  <div class="p-8 pb-0">
    <h1 class="text-3xl font-bold mb-4 text-purple-400">Ingredients</h1>
  </div>
  <div class="px-8">
    <input
      type="text"
      v-model="keyword"
      class="rounded border-2 bg-white border-gray-200 focus:ring-purple-400 focus:border-purple-400 mb-3 w-full"
